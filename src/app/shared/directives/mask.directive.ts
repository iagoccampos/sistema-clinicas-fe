...
import { Directive, ElementRef, Inject, Input, NgZone, OnInit, Optional, PLATFORM_ID, Renderer2, Self } from '@angular/core';
...
export class MaskDirective extends InputMaskDirective implements OnInit {
